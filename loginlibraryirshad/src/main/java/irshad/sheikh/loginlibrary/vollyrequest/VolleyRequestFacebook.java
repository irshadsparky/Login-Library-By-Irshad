...
public class VolleyRequestFacebook {
        ...
        if (Url != null && Url.length() > 0) {
            final StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    volleyRequestResponce.onLoginFailure(new SmartLoginException(error.getMessage(), LoginType.Facebook));
...
// Adding request to request queue
        ...
        {
            volleyRequestResponce.onLoginFailure(new SmartLoginException("Please Add Url", LoginType.Facebook));
        }
    }
